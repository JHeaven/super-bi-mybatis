...
public class Get_Cell_R_C {

	public static int getRC(String originalStr, CellMapper cellDao,Cell cellTop) {
				...
				if (cell.getUrl().contains("_z")) {
					...
					if (cell.getUrl().contains("_zmenu")) {
						...
						while(_zMenu > 0 ) {
							...
							int temp1 = cellUrlWithZq.indexOf("','") < cellUrlWithZq.indexOf("'") ? cellUrlWithZq.indexOf("','") :cellUrlWithZq.indexOf("'");
						...
						//single
						cell.setQcName(cell.getUrl().substring(cell.getUrl().indexOf("javascript:_z('") + 15, cell.getUrl().indexOf("',")));
					}
				}else{
					cell.setIsZq("N");
				}
